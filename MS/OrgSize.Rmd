...
Both before and at the end of our experiment, bromeliad species identity explains more variation in community composition of macroinvertebrates than any other organism type, less for zooplankton and less still for bacteria (`r fig("bw_spp")`, `r tab("perm_3sp")`). For all organism types, bromeliad species explained less of the variation in
