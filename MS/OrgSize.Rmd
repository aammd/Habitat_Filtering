...
filtered tank water from each plant (approximately 100ml plant^-1^), returning
the same volumes to all bromeliads. **Bromeliad preparation**: We emptied
bromeliads by hanging them upside down to dry for at least 24 hours and then
...
were placed in a local habitat similar to their original, each enclosed in a
2mm mesh cage to prevent colonization by insects. We then added the starting
...
For question 1, we performed a test for homogeniety of multivariate dispersions [@Anderson2006]
