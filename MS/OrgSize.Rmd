...
macroinvertebrates, weaker differences in zooplankton, and none in bacteria (`r fig("bw_spp")`). This
...
[], may vector one another [@Lopez1999], or may be dispersed non-randomly by an
...
Species interactions can also modify the distribution of animals. 
