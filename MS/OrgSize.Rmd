...
fig_nums("win_sp", "The x-axis has the group studied. the Y axis the r2 of the data from a PERMANOVA. It turns out that a organisms get smaller, the effect of time on the species composition of the data gets weaker; however this effect is not as extreme as in the model using multiple species.")
```
